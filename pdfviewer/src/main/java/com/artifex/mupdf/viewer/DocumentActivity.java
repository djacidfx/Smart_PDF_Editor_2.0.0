    ...
    public void createUI(Bundle savedInstanceState) {
        ...
        this.viewMode.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                MyCache.putBooleanValueByName(documentActivity, "view_mode", !MyCache.getBooleanValueByName(documentActivity, "view_mode", false));
                if (MyCache.getBooleanValueByName(DocumentActivity.this, "view_mode", false)) {
                    Toast.makeText(DocumentActivity.this, "Horizontal Mode", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(DocumentActivity.this, "Vertical Mode", Toast.LENGTH_SHORT).show();
                }
                setUpViewMode();
            }
        });
